...
connection_string = Driver={ODBC Driver 17 for SQL Server};Server=tcp:todosqlserverakkc.database.windows.net,1433;Database=todoappakkcdb;Uid=akkcadmin;Pwd=Surveillance1@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;
